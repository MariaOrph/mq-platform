...
const PUBLIC_PATHS = ['/login', '/auth/callback', '/auth/invite', '/auth/setup', '/auth/me', '/unauthorised', '/feedback', '/privacy', '/unsubscribe', '/programmes', '/book-a-call', '/api/bookings', '/api/health']
