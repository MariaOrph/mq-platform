...
const DIMENSIONS = [
  ...
  },
  {
    ...
    science: 'Amy Arnsten\'s research shows that even moderate stress takes the prefrontal cortex offline, reducing your capacity for clear thinking and sound judgment. Joseph LeDoux documented how the amygdala can hijack the whole system in milliseconds. Sigal Barsade\'s research on emotional contagion found that a leader\'s emotional state spreads through a team within minutes of entering a room — making regulation not just a personal practice, but a direct leadership responsibility. Viktor Frankl captured the core insight: between stimulus and response there is a space — and that space is what emotional regulation lets you access.',
  },
  {
