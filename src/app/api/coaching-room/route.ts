...
const DIMENSION_SCIENCE: Record<number, string> = {
  ...
  3: 'Amy Arnsten\'s research shows that even moderate stress takes the prefrontal cortex offline, reducing capacity for clear thinking and sound judgment. Joseph LeDoux documented how the amygdala can hijack the whole system in milliseconds. Sigal Barsade\'s research on emotional contagion found that a leader\'s emotional state spreads through a team within minutes of entering a room — making regulation not just a personal practice, but a direct leadership responsibility. Viktor Frankl captured the core insight: between stimulus and response there is a space — and emotional regulation is the practice of deliberately widening that space.',
