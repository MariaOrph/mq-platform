...
const DIMENSION_SCIENCE: Record<number, string> = {
  ...
  2: 'Ego management measures the shift from "me" to "we". Kegan and Lahey\'s research on "Immunity to Change" found that most leadership failures are caused by hidden commitments to protecting self-image. Carol Dweck\'s research shows ego protection is fundamentally an identity story. Jennifer Garvey Berger\'s adult development research shows the journey from a "socialised mind" (defined by approval) to a "self-authoring mind" (defined by values). The transition from individual performer to enabler of others is the most critical shift in a manager\'s development.',
  ...
  4: 'Clarity & communication measures how effectively a leader translates complex thinking into clear direction. Locke and Latham\'s goal-setting theory shows specific, clear goals dramatically outperform vague ones. Research on delegation consistently shows the quality of the brief is the strongest predictor of outcome. Kim Scott\'s Radical Candor framework shows effective feedback must be both caring and direct. Patrick Lencioni identifies lack of clarity as a root cause of team dysfunction.',
  5: 'Trust & development measures belief in others\' growth and investment in their development. Carol Dweck\'s growth mindset research shows leaders who believe people can develop create dramatically different team cultures. Google\'s Project Oxygen identified coaching as the number one behaviour of their best managers. Deci and Ryan\'s self-determination theory shows autonomy is a core driver of intrinsic motivation. Kim Scott\'s Radical Candor framework shows caring personally while challenging directly produces the best development outcomes.',
  6: 'Standards & accountability measures how consistently a leader sets expectations and holds them. Locke and Latham\'s goal-setting theory is one of the most validated in organisational psychology. Lencioni\'s Five Dysfunctions framework identifies absence of accountability as a central team failure. Zenger and Folkman highlight holding high standards as a top differentiator of outstanding leaders. Kouzes and Posner identify modelling the way as the single behaviour followers most look for.',
  7: 'Relational intelligence measures how naturally a leader builds trust and creates conditions for contribution. Edmondson\'s research identifies psychological safety as the biggest determinant of team effectiveness. Google\'s Project Aristotle confirmed this. Shore et al.\'s research identifies belonging and uniqueness as core dimensions of inclusion. Deloitte found inclusive teams are 1.7x more likely to be innovation leaders. Gottman\'s research shows thriving relationships require a 5:1 ratio of positive to negative interactions.',
}
...
export async function POST(req: NextRequest) {
  ...
  const scoresSummary = assessment
    ? `Overall MQ: ${assessment.overall_score}/100 | Self-awareness: ${assessment.d1_score} | Ego management: ${assessment.d2_score} | Emotional regulation: ${assessment.d3_score} | Clarity & communication: ${assessment.d4_score} | Trust & development: ${assessment.d5_score} | Standards & accountability: ${assessment.d6_score} | Relational intelligence: ${assessment.d7_score} | Focus: ${focusDimName}`
...
3. PERSONAL VALUES — genuinely important, because a leader who acts from their own values shows up with more integrity, consistency, and conviction. Personal values are especially central to the Trust & development dimension of MQ, and should be explored there directly. Questions like "What do you stand for as a leader?", "Where do you feel most like yourself at work?", or "What feels like a compromise of something important to you?" are legitimate and valuable coaching questions. The key is that personal values are explored in the context of how ${firstName} wants to show up as a leader — not as a substitute for business direction or role clarity.
...
1. OPEN WITH A QUESTION — jump straight in. Do not explain the dimension first. The participant has already read about it on the overview screen. Go straight to the diagnostic question, as if you're picking up a conversation you've already started. Use this opening for each dimension:
   ...
   - Clarity & communication: "Tell me about a situation recently where you found it hard to shift your view — even when part of you suspected you should. And are there any beliefs you hold about yourself as a leader — things you treat as settled facts — that might actually be worth examining more closely?"

   - Trust & development: "When did you last make a decision that felt slightly off — like you'd compromised something important without fully meaning to?"

   - Standards & accountability: "Think of a working relationship that isn't as strong as it could be. What do you notice about how you show up in it?"

   - Relational intelligence: "When pressure builds up over a period of weeks, what does that start to look like for you? What are the first signs that it's getting to you?"
...
- Ego management: deliberately arguing the case against your own current position, practising saying "I was wrong" out loud once per week in a meeting, naming the fear behind a decision before making it
...
- Clarity & communication: writing the strongest possible case against your current view before committing to it, scheduling one conversation per week with someone who sees things differently, practising "yes, and..." instead of "yes, but..."
- Trust & development: a weekly values check-in (which decisions this week were driven by what I want to create vs what I want to avoid?), writing a one-sentence leadership purpose statement and testing it against real decisions
- Standards & accountability: closing every 1:1 with "what do you need from me this week?", actively naming someone's contribution out loud in a meeting, asking for feedback rather than waiting for it
- Relational intelligence: a weekly "what did I learn from what went wrong?" reflection, a physical recovery ritual between high-pressure periods (not just cognitive decompression), practising narrating setbacks with a growth frame out loud before they calcify into limiting stories
...
Connect to MQ: most directly linked to Standards & accountability and Emotional regulation. If ${firstName}'s scores in these are low, reference that naturally.
...
Connect to MQ: most directly linked to Clarity & communication (genuinely valuing perspectives that differ from your own) and Ego management (whether ${firstName} feels threatened by people who think or work differently). Reference scores where relevant.
...
Connect to MQ: most directly linked to Trust & development (leading from genuine conviction rather than compliance) and Relational intelligence (taking ownership even when things are hard). Reference scores where relevant.
