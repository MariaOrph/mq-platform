...
export const CARD_LIBRARY: Record<number, Record<number, CardContent>> = {
  ...
  7: {
    1: {
      ...
      insight:  'Martin Seligman\'s research shows that resilience is not a trait; it is a practice. Resilient leaders do not experience fewer setbacks — they have shorter recovery times. The key variable is explanatory style: leaders who see setbacks as temporary and specific recover faster than those who see them as permanent and pervasive. George Bonanno\'s longitudinal research adds an important reframe: natural resilience — not prolonged distress — is the most common human response to adversity. Most people recover more readily than they expect. The question is not whether you have the capacity for resilience but whether you are actively using it or inadvertently working against it.',
    ...
    2: {
      ...
      insight:  'Carol Dweck\'s growth mindset research shows that leaders who view challenges as information rather than verdicts outperform their peers over time. Alia Crum\'s stress mindset research extends this precisely: people who view stress as enhancing rather than harmful perform better and are measurably healthier under pressure. A study tracking 30,000 adults for eight years found that high stress increased the risk of dying by 43% — but only in people who believed stress was harmful to their health. Those with equally high stress who did not hold that belief were among the least likely to die of anyone in the study. The mindset about the experience changes what the experience does to you. This is not toxic positivity; it is one of the most striking findings in modern stress research.',
    ...
    3: {
      ...
      insight:  'A study of senior executives found that tolerance for ambiguity is the single strongest predictor of effective leadership in complex, fast-moving organisations: stronger than IQ or technical skill. Albert Bandura\'s self-efficacy research explains the mechanism: leaders who have built a track record of navigating uncertainty successfully develop genuine belief in their capacity to handle it — and that belief is itself a primary driver of performance under pressure. Self-efficacy is not confidence as a personality trait; it is evidence-based trust in yourself, built deliberately through mastery experiences. Each time you hold uncertainty without it destabilising you, you are making a deposit.',
    ...
    4: {
      ...
      insight:  'Richard Tedeschi and Lawrence Calhoun\'s research on post-traumatic growth found that many people don\'t just recover from adversity — they grow in five specific areas: personal strength, new possibilities, relating to others, appreciation of life, and existential or spiritual change. The key variable is narrative: the story people construct about who they became through difficulty. Leaders who can articulate how past challenges shaped their capabilities are significantly more likely to perform effectively in future high-pressure situations — not because difficulty was good, but because they extracted something real from it. This exercise builds that narrative deliberately, before the next hard thing arrives.',
