...
export const CARD_LIBRARY: Record<number, Record<number, CardContent>> = {
  ...
  2: {
    1: {
      ...
      exercise: 'Think of a current challenge you\'re facing — one where you already have a strong view. Now write the strongest possible case for the OPPOSITE position. Not a strawman — a genuinely compelling argument. What data supports it? What would a smart person who disagrees say? Does anything shift for you?',
    },
    2: {
    ...
    3: {
      ...
      insight:  'When leaders practice intentional reframing, research shows they report lower stress and make measurably better decisions under pressure. A problem framed as a threat activates avoidance; the same problem framed as a challenge activates creativity. The facts don\'t change — but what becomes possible does.',
  ...
  4: {
    ...
    2: {
      ...
      exercise: 'Think of the last time you made a decision under time or social pressure. Write: (1) What did you decide? (2) Which of your values did it reflect? (3) Which values, if any, did you compromise? Now: what decision are you facing right now where you might choose convenience over integrity? Write down what integrity looks like in that moment.',
    },
    3: {
